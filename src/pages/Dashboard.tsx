  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <StatCard title="Total Cases" value={cases.length} icon={<FileText className="text-emerald-600" />} />
      ...
      {/* Filters */}
      <div className="bg-stone-50 p-4 rounded-xl shadow-sm border border-stone-200 flex flex-col md:flex-row gap-4">
      ...
      {/* Advanced Filters */}
      <div className="bg-stone-50 p-4 rounded-xl shadow-sm border border-stone-200 flex flex-col md:flex-row gap-4 items-center">
          ...
          <table className="w-full text-left">
            ...
            <tbody className="divide-y divide-stone-200">
              {loading ? (
                ...
                filteredCases.map((c) => (
                  <tr key={c.id} className="hover:bg-stone-100 transition-colors">
...
function StatCard({ title, value, icon }: { title: string, value: number, icon: React.ReactNode }) {
  return (
    <div className="bg-stone-50 p-6 rounded-xl shadow-sm border border-stone-200">
